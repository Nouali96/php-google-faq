<?php
    $faqs = [
        ...
        [
            'domanda'=>"Perché il mio account è associato a un paese?<br><br>",
        ...
        [
            'domanda'=>"Stabilire il paese associato al tuo account<br><br>",
...
<body>
    <header>
        <div class="header-top flex">
            <img src="https://gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="LogoGoogle">
